...
#define STRING_CONFIG_H_AUTHOR "(Daniel, Nimsgern)" // Original author or contributor.
...
#define MACHINE_UUID "18fa68d1-0998-41fe-99a2-2804180e914b"
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define MESH_INSET 1              // Set Mesh boundDIAG_JUMPERS_REMOVEDs as an inset region of the bed
  ...
  #if ENABLED(AVOID_OBSTACLES)DIAG_JUMPERS_REMOVED
...
// Panel connected to main board by SPI or I2C interface.200
...
#define NEOPIXEL_LED
  ...
  #define NEOPIXEL2_SEPARATE
    ...
    #define NEOPIXEL2_TYPE          NEO_GRB // NEO_GRBW, NEO_RGBW, NEO_GRB, NEO_RBG, etc.
